    ...
    return (
        <div className="bg-[url('/dna.png')] bg-center bg-cover bg-[#1BBAC8] bg-opacity-10 py-10">
            <div className="flex flex-col md:flex-row px-[4%] items-center">
                <img src="/office.jpeg" className="w-full rounded-xl md:w-[45%] mb-6 lg:mb-0" alt="Office" />
                <div className="flex flex-col w-full lg:w-[45%] pl-0 lg:pl-[5%]">
                    <h1 className="text-[#042182] text-3xl sm:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold">About Us</h1>
                    <p className="py-6 sm:py-8 text-lg sm:text-xl lg:text-2xl 2xl:text-3xl">
                        Eastern Scientific Corporation (Pvt) Ltd. is a scientific and AgriTech
                        company in Pakistan, operating across the food, agriculture, and life
                        sciences sectors. As part of the Eastern Group, a vertically integrated Life Sciences and
                        AgriTech platform, ESC supports quality, safety, and innovation within the
                        agri-food ecosystem.
                    </p>
