...
const Hero = ({ text, images = [] }) => {
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden" role="region" aria-label="Hero Carousel">
      {/* Show loader if images are not fully loaded */}
      {!allImagesLoaded && (
      ...
      {images.map((image, index) => (
        ...
        >
          ...
          />
          <h1 className="absolute top-[60%] text-white text-3xl md:text-5xl font-semibold px-[4%] w-full md:w-1/2">
            {text}
          </h1>
        </div>
      ))}
