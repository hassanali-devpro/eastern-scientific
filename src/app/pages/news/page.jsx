...
const cardsData = [
  {
    id: 0,
    title: "Visit to Pakistan’s Largest Buffalo Dairy Farm",
        images: [media[54], media[55],  media[56]],
    
    description:
      "A productive visit to Pakistan’s largest buffalo dairy farm and the first Disease-Free Compartments in Punjab, Pakistan. We congratulate JW Group and Royal Group China on their strategic partnership to revitalize Pakistan’s buffalo sector. We also extend our sincere appreciation to the Livestock & Dairy Development Department, Punjab, for its support in achieving this significant milestone and for its commitment to advancing the future of the livestock and dairy industry in Pakistan.",
  },
  {
    id: 1,
    title: "Visit to PAFDA",
    images: [ media[52],media[53]],
    description:
      "A glimpse of our recent visit to PAFDA, where we had the privilege of meeting Dr. Talat Naseer Pasha, Director General of PAFDA, and Dr. Muhammad Nasir, Member Food–PAFDA, alongside agriculturalists, exporters, and industry stakeholders. The visit provided a valuable opportunity to exchange insights and explore practical pathways for sustainable growth, food safety, innovation, and economic development in Pakistan. We look forward to fostering continued collaboration in support of a stronger and more resilient agri-food sector.",
  },
  {
    id: 2,
    title: "Dairy Asia Expo 2026",
    images: [media[48], media[49], media[50], media[51],],

    description:
      "Eastern Scientific Corporation was honored to welcome esteemed public figures and industry leaders to our stall on the first day of Dairy Asia Expo. Their visit provided a valuable opportunity to showcase our innovative solutions for the agri-food, veterinary, and dairy industries. We sincerely appreciate their interest, insightful discussions, and continued support as we work together to advance the future of these sectors.",
  },
  {
    id: 3,
    title: "78th Independence Day & Eastern Tower Inauguration",
    images: [media[45], media[46], media[47]],
    description:
    ...
    >
      <div className="relative w-full h-48 mb-3">
        ...
        <img
          ...
          alt={card.title}
          className={`rounded-lg w-full h-48 object-cover transition-opacity duration-300 ${loading ? "opacity-0" : "opacity-100"
            }`}
